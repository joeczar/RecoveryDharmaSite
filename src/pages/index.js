...
const IndexPage = () => (
  <Layout>
    <SEO title="Home" />
    <Headline>
      <h1>Using Buddhist Practices and Principles to Heal the Suffering of Addiction</h1>
    </Headline>
    <Article
      id="homeArticle"
    ...
    >
      ...
      <p>Recovery Dharma welcomes anyone who is looking to heal from
      addiction and addictive behavior, whether it’s caused by substance use
      or process addictions like codependency, gambling, eating disorders,
      relationships, technology, or any obsessive or habitual pattern that
      creates suffering. We’ve found that this Buddhist-inspired path can lead
      to liberation from the suffering of addiction, and we support you in
